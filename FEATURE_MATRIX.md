...
3. Complete the started Syslinux BIOS/dual-firmware profile by integrating its
   bounded config/C32 policy into private staging and device writes, then pass
   QEMU/SeaBIOS/OVMF gates and physical certification.

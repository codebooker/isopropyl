...
3. Complete the started Syslinux BIOS/dual-firmware profile by binding the
   implemented staged-tree policy, mount-free anonymous FAT32 builder, and
   regular-file patch transaction into one witnessed production ISO plan. Then
   add bounded privileged device streaming/read-back and pass QEMU/SeaBIOS/OVMF
   gates plus physical certification.

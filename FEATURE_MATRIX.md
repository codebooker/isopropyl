...
3. Complete the started Syslinux BIOS/dual-firmware profile with pinned MBR code,
   bounded device writes, QEMU/SeaBIOS/OVMF gates, and physical certification.

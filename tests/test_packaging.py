...
class SourceInstallTests(unittest.TestCase):
    ...
    def test_make_install_replaces_an_existing_package_without_nesting(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertTrue((package / "grub_rescue.py").is_file())
            self.assertTrue((package / "grub_rescue_device.py").is_file())
            self.assertTrue((package / "grub_rescue_device_runner.py").is_file())
            self.assertTrue((package / "grub_rescue_workflow.py").is_file())

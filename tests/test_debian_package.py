...
class DebianPackageTests(unittest.TestCase):
    ...
    def test_payload_has_safe_ownership_types_and_modes(self):
        ...
        required = {
            ...
            "usr/lib/python3/dist-packages/isopropyl/descriptor_io.py",
            "usr/lib/python3/dist-packages/isopropyl/freedos_downloads.py",
            "usr/lib/python3/dist-packages/isopropyl/grub_rescue.py",
            "usr/lib/python3/dist-packages/isopropyl/grub_rescue_device.py",
            "usr/lib/python3/dist-packages/isopropyl/grub_rescue_device_runner.py",
            "usr/lib/python3/dist-packages/isopropyl/grub_rescue_workflow.py",
